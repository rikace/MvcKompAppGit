...
namespace MVCNestedModels.Controllers
{
    ...
    [HandleError, SessionState(System.Web.SessionState.SessionStateBehavior.Required)]
    public class AccountController : Controller
    {
        ...
        public ActionResult EditDetailToDo(int id)
        {
            ...
            if (id == 0) return this.ClentValidationView("EditDetailToDo", new ToDoItem());

            Tracker<ToDoItem> t = FindTrackerToDo(id);
            if (t != null) return this.ClentValidationView("EditDetailToDo", t.Value);
            return this.ClentValidationView("EditDetailToDo", new ToDoItem());
        }
        ...
        public ActionResult EditDetailToDo(ToDoItem item)
        {
            ...
            return this.ClentValidationView("EditDetailToDo", item);
        }
