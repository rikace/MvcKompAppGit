...
namespace MVCNestedModels.Models
{
    ...
    public class RegisterModel
    {
        ...
        [DateRange(DynamicMaximum = "Stop", RangeAction = RangeAction.Propagate, 
            DynamicMaximumDelay = "Delay", SMaximum = "2012-1-1", SMinimum = "2008-1-1"), DisplayFormat(DataFormatString="{0:G}")]
        public DateTime Start {get;set;}

        [MileStone]
        public TimeSpan Delay{get;set;}
        public TimeSpan InvDelay { get { return -Delay; } }
        [Format(ClientFormat="S")]
        [DateRange(DynamicMinimum="Start", SMaximum = "2012-1-1", SMinimum = "2008-1-1", DynamicMinimumDelay = "InvDelay", RangeAction = RangeAction.Propagate)]
        public DateTime Stop { get; set; }

        public List<Tracker<ToDoItem>> ToDoList { get; set; }
        ...
        public Expression<Func<ToDoItem, bool>> ItemFilter{get; set;}
