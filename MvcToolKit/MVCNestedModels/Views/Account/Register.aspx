               ...
               Absolute values are transformed into Total+Percentages, and the inverse transformation is applied when the View is posted
                ...
                <div class="editor-label">
                 ...
                 Html.SortableListFor(convertedKeywords, 
                    ...
                    itemCss: "normalRow", altItemCss: "alternateRow", enableMultipleInsert:false)
                  %>
                ...
                <table>
                    ...
                    <%: Html.DataGridFor(m => m.ToDoList, ItemContainerType.tr, 
                     "ToDoEditItem", "ToDoDisplayItem", null, "ToDoInsertItem", null,
                     itemCss: "normalRow", altItemCss: "alternateRow",
                ...
                <%: Html.EnableSortingFor(m => m.ToDoList, m => m.ToDoOrder, "NormalHeaderToDo", "AscendingHeaderToDo", "DescendingHeaderToDo", causePostback: false, page: m => m.Page) %>
                ...
                <%:Html.SelectionButton("choice 1", "choice1", "choiceTest", "choice1_button", ManipulationButtonStyle.Link) %>
                <%:Html.SelectionButton("choice 2", "choice2", "choiceTest", "choice2_button", ManipulationButtonStyle.Link) %>
                <%:Html.SelectionButton("choice 3", "choice3", "choiceTest", "choice3_button", ManipulationButtonStyle.Link) %>
                    <input id="Checkbox6" type="checkbox" class="choiceTest_checkbox choice1_checkbox" />
                    <input id="Checkbox7" type="checkbox" class="choiceTest_checkbox choice2_checkbox"/>
                    <input
                        id="Checkbox8" type="checkbox" class="choiceTest_checkbox choice3_checkbox"/>
                </div>
                <div id="fatherChoices">
                A
                <div id="choice1"  class="choiceTest"><%: Html.DataFilter(m=>m.ItemFilter, new ToDoItemByNameFilter(), "ToDoItemByNameFilterView") %></div>
                B
                <div id="choice2"  class="choiceTest">choice 2</div>
                C
                <div id="choice3"  class="choiceTest">choice 3</div>
                D
                </div>
            <div>
