...
ko.exportSymbol=function(c,a){var e=c.split(".");var d=window;for(var b=0;b<e.length-1;b++){d=d[e[b]]}d[e[e.length-1]]=a};ko.exportProperty=function(b,a,c){b[a]=c};(function(){ko.mapping={};var j="__ko_mapping__";var n=0;var c=ko.dependentObservable;var o;ko.mapping.fromJS=function(s,t,u){if(arguments.length==0){throw new Error("When calling ko.fromJS, pass the object you want to convert.")}t=d(t);var r=i(u,s,t);r[j]=r[j]||{};r[j]=t;return r};ko.mapping.fromJSON=function(t,s){var r=ko.utils.parseJson(t);return ko.mapping.fromJS(r,s)};ko.mapping.isMapped=function(s){var r=ko.utils.unwrapObservable(s);return r&&r[j]};ko.mapping.updateFromJS=function(s,r){if(arguments.length<2){throw new Error("When calling ko.updateFromJS, pass: the object to update and the object you want to update from.")}if(!s){throw new Error("The object is undefined.")}if(!s[j]){throw new Error("The object you are trying to update was not created by a 'fromJS' or 'fromJSON' mapping.")}return i(s,r,s[j])};ko.mapping.updateFromJSON=function(t,u,s){var r=ko.utils.parseJson(u);return ko.mapping.updateFromJS(t,r,s)};ko.mapping.toJS=function(s,r){if(arguments.length==0){throw new Error("When calling ko.mapping.toJS, pass the object you want to convert.")}r=r||{};r.ignore=r.ignore||[];if(!(r.ignore instanceof Array)){r.ignore=[r.ignore]}r.ignore.push(j);return ko.mapping.visitModel(s,function(t){return ko.utils.unwrapObservable(t)},r)};ko.mapping.toJSON=function(t,r){var s=ko.mapping.toJS(t);return ko.utils.stringifyJson(s,r)};function m(r){if((r)&&(typeof(r)==="object")&&(r.constructor==(new Date).constructor)){return"date"}return typeof r}function d(r){r=r||{};if((r.create instanceof Function)||(r.key instanceof Function)||(r.arrayChanged instanceof Function)){r={"":r}}return r}var f=function(){ko.dependentObservable=function(){var r=arguments[2]||{};r.deferEvaluation=true;var s=new c(arguments[0],arguments[1],r);s.__ko_proto__=c;o.push(s);return s}};var q=function(){ko.dependentObservable=c};function i(u,t,s){if(!n){o=[]}n++;var r=k(u,t,s);n--;return r}function k(r,J,u,H,E,z){var C=ko.utils.unwrapObservable(J) instanceof Array;if(ko.mapping.isMapped(r)){u=ko.utils.unwrapObservable(r)[j]}var t=function(){return u[E]&&u[E].create instanceof Function};H=H||new g();if(H.get(J)){return r}E=E||"";if(!C){if(!e(J)){switch(m(J)){case"function":r=J;break;default:if(ko.isWriteableObservable(r)){r(ko.utils.unwrapObservable(J))}else{r=ko.observable(ko.utils.unwrapObservable(J))}break}}else{if(!r){if(t()){f();var B=u[E].create({data:J,parent:z});q();return B}else{r={}}}H.save(J,r);h(J,function(M){var N;var O=H.get(J[M]);if(O){r[M]=O}else{r[M]=k(r[M],J[M],u,H,M,r)}})}}else{var K=[];var y=function(M){return M};if(u[E]&&u[E].key){y=u[E].key}if(!ko.isObservable(r)){r=ko.observableArray([]);r.mappedRemove=function(N){var M=typeof N=="function"?N:function(O){return O===y(N)};return r.remove(function(O){return M(y(O))})};r.mappedRemoveAll=function(N){var M=b(N,y);return r.remove(function(O){return ko.utils.arrayIndexOf(M,y(O))!=-1})};r.mappedDestroy=function(N){var M=typeof N=="function"?N:function(O){return O===y(N)};return r.destroy(function(O){return M(y(O))})};r.mappedDestroyAll=function(N){var M=b(N,y);return r.destroy(function(O){return ko.utils.arrayIndexOf(M,y(O))!=-1})};r.mappedIndexOf=function(O){var N=b(r(),y);var M=y(O);return ko.utils.arrayIndexOf(N,M)}}var D=b(ko.utils.unwrapObservable(r),y).sort();var w=b(J,y).sort();var v=ko.utils.compareArrays(D,w);var A=[];for(var G=0,F=v.length;G<F;G++){var L=v[G];switch(L.status){case"added":var I=p(ko.utils.unwrapObservable(J),L.value,y);var s=ko.utils.unwrapObservable(k(undefined,I,u,H,E,r));var x=ko.utils.arrayIndexOf(ko.utils.unwrapObservable(J),I);A[x]=s;break;case"retained":var I=p(ko.utils.unwrapObservable(J),L.value,y);var s=p(r,L.value,y);k(s,I,u,H,E,r);var x=ko.utils.arrayIndexOf(ko.utils.unwrapObservable(J),I);A[x]=s;break;case"deleted":var s=p(r,L.value,y);r.remove(s);break}K.push({event:L.status,item:s})}r(A);if(u[E]&&u[E].arrayChanged){ko.utils.arrayForEach(K,function(M){u[E].arrayChanged(M.event,M.item)})}}return r}function l(r,t){var s;if(t){s=t(r)}if(!s){s=r}return ko.utils.unwrapObservable(s)}function p(u,s,t){var r=ko.utils.arrayFilter(ko.utils.unwrapObservable(u),function(v){return l(v,t)==s});if(r.length==0){throw new Error("When calling ko.update*, the key '"+s+"' was not found!")}if((r.length>1)&&(e(r[0]))){throw new Error("When calling ko.update*, the key '"+s+"' was not unique!")}return r[0]}function b(s,r){return ko.utils.arrayMap(ko.utils.unwrapObservable(s),function(t){if(r){return l(t,r)}else{return t}})}function a(r,x,w,A,B){var u=b(x,w).sort();var v=b(r,w).sort();var y=ko.utils.compareArrays(v,u);for(var t=0,s=y.length;t<s;t++){var z=y[t];switch(z.status){case"added":var C=p(ko.utils.unwrapObservable(x),z.value,w);A("added",C);break;case"retained":var C=p(x,z.value,w);A("retained",C);break;case"deleted":var C=p(ko.utils.unwrapObservable(r),z.value,w);A("deleted",C);break}}}function h(t,u){if(t instanceof Array){for(var s=0;s<t.length;s++){u(s)}}else{for(var r in t){u(r)}}}function e(r){return(m(r)=="object")&&(r!==null)&&(r!==undefined)}ko.mapping.visitModel=function(u,w,s){s=s||{};s.visitedObjects=s.visitedObjects||new g();var v;var r=ko.utils.unwrapObservable(u);if(!e(r)){return w(u,s.parentName)}else{w(u,s.parentName);v=r instanceof Array?[]:{}}s.visitedObjects.save(u,v);var t=s.parentName;h(r,function(z){if(s.ignore&&ko.utils.arrayIndexOf(s.ignore,z)!=-1){return}var x=r[z];s.parentName=t||"";if(r instanceof Array){if(t){s.parentName+="["+z+"]"}}else{if(t){s.parentName+="."}s.parentName+=z}var y;switch(m(ko.utils.unwrapObservable(x))){case"object":case"undefined":var A=s.visitedObjects.get(x);v[z]=(A!==undefined)?A:ko.mapping.visitModel(x,w,s);break;default:v[z]=w(x,s.parentName)}});return v};function g(){var s=[];var r=[];this.save=function(u,v){var t=ko.utils.arrayIndexOf(s,u);if(t>=0){r[t]=v}else{s.push(u);r.push(v)}};this.get=function(u){var t=ko.utils.arrayIndexOf(s,u);return(t>=0)?r[t]:undefined}}ko.exportSymbol("ko.mapping",ko.mapping);ko.exportSymbol("ko.mapping.fromJS",ko.mapping.fromJS);ko.exportSymbol("ko.mapping.fromJSON",ko.mapping.fromJSON);ko.exportSymbol("ko.mapping.isMapped",ko.mapping.isMapped);ko.exportSymbol("ko.mapping.toJS",ko.mapping.toJS);ko.exportSymbol("ko.mapping.toJSON",ko.mapping.toJSON);ko.exportSymbol("ko.mapping.updateFromJS",ko.mapping.updateFromJS);ko.exportSymbol("ko.mapping.updateFromJSON",ko.mapping.updateFromJSON);ko.exportSymbol("ko.mapping.visitModel",ko.mapping.visitModel)})();