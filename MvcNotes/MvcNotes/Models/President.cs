...
namespace Entity
{
    public class President : IEntity
    {
        [Key]
    ...
    {
        public static List<President> GetList()
        {
            List<President> list = new List<President>
            {
                ...
                new President
                {
                    ...
                    FirstName = "James",
                    LastName = "Polk",
                    TookOffice = new DateTime(1845, 4, 4),
                ...
                new President
                {
                    ...
                    FirstName = "Zachary",
                    LastName = "Taylor",
                    TookOffice = new DateTime(1849, 4, 4),
                ...
                new President
                {
                    ...
                    LeftOffice = new DateTime(1865, 3, 4),
                    Party = "Republican",
                    NumTerms = 1
                },
                new President
                ...
                new President
                {
                    ...
                    FirstName = "Calvin",
                    LastName = "Coolidge",
                    TookOffice = new DateTime(1920, 8, 2),
